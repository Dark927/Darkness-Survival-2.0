...
{
    [CreateAssetMenu(fileName = "NewAttackNegativeStatus", menuName = "Game/Combat/Data/Attacks/AttackNegativeStatus")]
    public class AttackNegativeStatus : ScriptableObject
    {
        #region Fields
